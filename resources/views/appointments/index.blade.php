...
@section('content')
<div x-data="appointmentsData()" x-init="loadUsers()">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Agendamentos</h2>
            <p class="text-gray-500 text-sm">Gerenciamento de agendamentos</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">Consultar Horários Disponíveis</h3>
        <div class="flex flex-wrap gap-4">
            ...
            <div x-show="filters.attendantId && filters.date"
                 class="flex items-end">
                <button @click="loadSlots()"
                        class="px-4 py-2 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700">
                    Buscar Horários
                </button>
            </div>
            ...
            <div class="flex flex-wrap gap-2">
                <template x-for="slot in slots" :key="slot.start_time + slot.end_time">
                    <button @click="selectSlot(slot)"
                            ...
                            :class="selectedSlot === slot ? 'border-blue-500 bg-blue-50 text-blue-700' : ''">
    ...
    <div x-show="selectedSlot" class="mt-8">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">Confirmar Agendamento</h3>
        <div class="bg-white rounded-lg shadow-sm p-6">
            <form @submit.prevent="handleBook()" class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <button type="button" @click="cancelSlotSelection()"
